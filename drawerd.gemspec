...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{generate erd for rails, using rails-erd and drawerd.com service.}
  spec.description   = %q{Generate erd for rails, usiing rails-erd and drawerd.com service.}
